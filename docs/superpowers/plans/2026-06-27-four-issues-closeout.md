...
- [ ] **Step 3: Implement service update helper**
...
- [ ] **Step 4: Route callers through the service**
...
- [ ] **Step 3: Split focused build/sync tests**
...
- [ ] **Step 1: Run repository commit checks**
