"""LLM runtime adapters used by legacy chat routes."""
...
def build_complete_llm_answer_with_tools_adapter(
    *,
    complete_llm_answer_with_tools: Callable[
        ..., Awaitable[tuple[str, str, list[dict]]]
    ],
    resolve_llm_config: Callable[[], dict],
    get_llm_client: Callable[[dict], Any],
):
    async def adapter(
        ...
        *,
        ...
        return await complete_llm_answer_with_tools(
            messages,
            tools=tools,
