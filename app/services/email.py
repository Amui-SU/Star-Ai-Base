...
<body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; max-width: 480px; margin: 0 auto; padding: 32px 20px; color: #222220;">
  ...
  <p style="margin:0 0 24px;color:#8a8680;font-size:15px;">用于注册 智库云 账号，{valid_minutes} 分钟内有效。</p>
...
async def send_verification_email(to_email: str, code: str) -> bool:
    ...
    msg["Subject"] = "智库云 — 邮箱验证码"
    msg["From"] = settings.smtp_from or settings.smtp_user
    msg["To"] = to_email

    html = VERIFICATION_HTML.format(code=code, valid_minutes=5)
